...
def delete_other_user(_step, name):
    ...
    # confirm prompt
    world.css_click(".wrapper-prompt-warning .action-primary", success_condition=lambda: world.is_css_not_present(".wrapper-prompt-warning .action-primary", wait_time=1))
