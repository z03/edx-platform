...
(MetadataModel, MetadataModelCollection, MetadataView) ->
    ...
    describe "Test Metadata Editor", ->
        ...
        describe "MetadataView.Editor creates editors for each field", ->
            beforeEach ->
                @model = new MetadataModelCollection(
                    [
                        integerEntry,
                        floatEntry,
                        selectEntry,
            ...
            it "returns an empty string if there is no display name property with a valid value", ->
                view = new MetadataView.Editor({collection: new MetadataModelCollection()})
